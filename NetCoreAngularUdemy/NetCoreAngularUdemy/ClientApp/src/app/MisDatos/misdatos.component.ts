...
export class MisDatosComponent implements OnInit {
  ...
  constructor(private servicioLogin: UsuarioApiService, private formBuilder: FormBuilder, private servicioCliente: ClienteService/*, private modalService: NgbModal*/) {
    this.usuarioAPI = {
